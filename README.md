...
```
$ docker image tag ms04 gcr.io/payment-platform-204588/ms04
$ docker push gcr.io/payment-platform-204588/ms04
```
...
\$ kubectl scale deployment <app-name> --replicas <replica-count> -n nothing
...
\$ kubectl set image deployment/<app-name>-app <app-name>=<new-image> -n nothing
